...
def upgrade():
    ...
    op.create_index(op.f('ix_injured_around_school_all_data_id'), 'injured_around_school_all_data', ['id'],
                    unique=False)
    op.create_index(op.f('ix_injured_around_school_all_data_school_id'), 'injured_around_school_all_data',
    ...
    op.create_index(op.f('ix_injured_around_school_school_yishuv_name'), 'injured_around_school',
                    ['school_yishuv_name'], unique=False)
    op.create_index(op.f('ix_schools_with_description_municipality_name'), 'schools_with_description',
                    ['municipality_name'], unique=False)
    op.create_index(op.f('ix_schools_with_description_school_id'), 'schools_with_description', ['school_id'],
                    unique=False)
    op.create_index(op.f('ix_schools_with_description_yishuv_name'), 'schools_with_description', ['yishuv_name'],
                    unique=False)
