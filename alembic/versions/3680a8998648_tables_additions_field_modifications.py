...
def upgrade():
    ...
    op.create_table('involved_no_location',
                    ...
                    sa.ForeignKeyConstraint(['accident_id', 'provider_code'],
                                            ['markers_no_location.id', 'markers_no_location.provider_code'],
                                            ondelete='CASCADE'),
    ...
    op.create_index('provider_and_id_idx_vehicles_no_location', 'vehicles_no_location', ['provider_and_id'],
                    unique=False)
    op.add_column('involved', sa.Column('accident_month', sa.Integer(), nullable=True))
    op.add_column('involved', sa.Column('accident_year', sa.Integer(), nullable=True))
    op.add_column('involved', sa.Column('car_id', sa.Integer(), nullable=True))
    op.add_column('involved', sa.Column('home_natural_area', sa.Integer(), nullable=True))
    op.add_column('involved', sa.Column('home_region', sa.Integer(), nullable=True))
    op.add_column('involved', sa.Column('involve_id', sa.Integer(), nullable=True))
    op.add_column('involved', sa.Column('involve_yishuv_symbol', sa.Integer(), nullable=True))
    op.add_column('involved', sa.Column('provider_and_id', sa.BigInteger(), nullable=True))
    op.create_index('provider_and_id_idx_involved', 'involved', ['provider_and_id'], unique=False)
    op.drop_column('involved', 'home_area')
    op.drop_column('involved', 'home_city')
    op.drop_column('involved', 'home_nafa')
    op.add_column('markers', sa.Column('accident_day', sa.Integer(), nullable=True))
    op.add_column('markers', sa.Column('accident_hour', sa.Integer(), nullable=True))
    ...
    op.add_column('markers', sa.Column('accident_month', sa.Integer(), nullable=True))
    op.add_column('markers', sa.Column('accident_year', sa.Integer(), nullable=True))
    op.add_column('markers', sa.Column('home', sa.Integer(), nullable=True))
    op.add_column('markers', sa.Column('non_urban_intersection', sa.Integer(), nullable=True))
    op.add_column('markers', sa.Column('provider_and_id', sa.BigInteger(), nullable=True))
    op.add_column('markers', sa.Column('street1', sa.Integer(), nullable=True))
    op.add_column('markers', sa.Column('street2', sa.Integer(), nullable=True))
    op.add_column('markers', sa.Column('urban_intersection', sa.Integer(), nullable=True))
    ...
    op.add_column('vehicles', sa.Column('provider_and_id', sa.BigInteger(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('vehicles', 'provider_and_id')
    op.drop_index('id_idx_markers', table_name='markers')
    ...
    op.drop_column('markers', 'street2')
    op.drop_column('markers', 'street1')
    op.drop_column('markers', 'provider_and_id')
    op.drop_column('markers', 'non_urban_intersection')
    op.drop_column('markers', 'home')
    op.drop_column('markers', 'accident_year')
    op.drop_column('markers', 'accident_month')
    op.drop_column('markers', 'accident_minute')
    op.drop_column('markers', 'accident_hour_raw')
    op.drop_column('markers', 'accident_hour')
    op.drop_column('markers', 'accident_day')
    op.add_column('involved', sa.Column('home_nafa', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('involved', sa.Column('home_city', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('involved', sa.Column('home_area', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_index('provider_and_id_idx_involved', table_name='involved')
    op.drop_column('involved', 'provider_and_id')
    op.drop_column('involved', 'involve_yishuv_symbol')
    op.drop_column('involved', 'involve_id')
    op.drop_column('involved', 'home_region')
    op.drop_column('involved', 'home_natural_area')
    op.drop_column('involved', 'car_id')
    op.drop_column('involved', 'accident_year')
    op.drop_column('involved', 'accident_month')
