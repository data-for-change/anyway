...
def upgrade():
    ...
    op.create_table('discussions', schema='public',
    ...
    op.create_table('highlight_markers', schema='public'
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('latitude', sa.Float(), nullable=True),
    sa.Column('longitude', sa.Float(), nullable=True),
    sa.Column('created', sa.DateTime(), nullable=True),
    ...
    op.create_table('markers', schema='public'
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('latitude', sa.Float(), nullable=True),
    sa.Column('longitude', sa.Float(), nullable=True),
    sa.Column('type', sa.Integer(), nullable=True),
    ...
    op.create_table('roles', schema='public'
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('users', schema='public'
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('general_preferences', schema='public'
    ...
    op.create_table('involved', schema='public'
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('report_preferences', schema='public'
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_table('roles_users', schema='public'
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('role_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['role_id'], ['roles.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], )
    )
    op.create_table('vehicles', schema='public'
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('provider_code', sa.Integer(), nullable=True),
    sa.Column('accident_id', sa.Integer(), nullable=True),
