...
Revision ID: 5860a2ed5ffc
Revises: d8f0c029862a
Create Date: 2020-06-16 13:04:17.671719

"""

# revision identifiers, used by Alembic.
revision = "5860a2ed5ffc"
down_revision = "d8f0c029862a"
branch_labels = None
depends_on = None

from alembic import op

# Those are redefined so the migration will be valid even if the views in the source code will be
# modified.
...
def downgrade():
    ...
    op.execute(f"CREATE OR REPLACE VIEW markers_hebrew AS {VEHICLES_HEBREW_VIEW}")
