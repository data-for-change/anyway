...
class Views(object):
    ...
    def create_involved_hebrew_view(self):
        ...
        from_clause = table \
            ...
            .join(LateDeceased,
                  ...
                  isouter=True) \
            .join(DidntCross,
                  and_(Involved.didnt_cross == DidntCross.id,
                       Involved.accident_year == DidntCross.year,
                       Involved.provider_code == DidntCross.provider_code),
                  isouter=True) \
            .join(CrossMode,
                  and_(Involved.cross_mode == CrossMode.id,
                       Involved.accident_year == CrossMode.year,
                       Involved.provider_code == CrossMode.provider_code),
                  isouter=True) \
            .join(CrossLocation,
                  and_(Involved.cross_location == CrossLocation.id,
                       Involved.accident_year == CrossLocation.year,
                       Involved.provider_code == CrossLocation.provider_code),
                  isouter=True) \
            .join(CrossDirection,
    ...
    def create_involved_hebrew_markers_hebrew_view(self):
        selected_columns = [
            ...
            InvolvedView.didnt_cross,
            InvolvedView.didnt_cross_hebrew,
            InvolvedView.cross_mode,
            InvolvedView.cross_mode_hebrew,
            InvolvedView.cross_location,
            InvolvedView.cross_location_hebrew,
            InvolvedView.cross_direction,
            InvolvedView.cross_direction_hebrew,
