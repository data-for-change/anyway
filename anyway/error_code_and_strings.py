...
class Errors:
    ...
    BR_USER_ALREADY_IN = 14
    BR_MISSING_PERMISSION = 15
    BR_USER_NOT_IN = 16
    BR_USER_NOT_ACTIVE = 17
    BR_BAD_NAME = 18
    BR_EXIST = 19
    BR_BAD_DESCRIPTION = 20
    BR_DESCRIPTION_MISSING = 21
    BR_NO_MODE = 22
    BR_BAD_MODE = 23
    BR_FIELD_MISSING = 24
    BR_BAD_AUTH = 25
...
ERROR_TO_STRING_DICT = {
    ...
    Errors.BR_USER_NOT_IN: "Bad Request (User(email:{}) is not in {}).",
    Errors.BR_USER_NOT_ACTIVE: "Bad Request (User is not active).",
    Errors.BR_BAD_NAME: "Bad Request (Bad name, need to be more then 2 char, less then 127 and only those chars - a-zA-Z0-9_-).",
    Errors.BR_EXIST: "Bad Request (Name already exists).",
    Errors.BR_BAD_DESCRIPTION: "Bad Request (Bad description, need to be less then 255 chars).",
    Errors.BR_DESCRIPTION_MISSING: "Bad Request (Description is missing from request json).",
...
ERROR_TO_HTTP_CODE_DICT = {
    ...
    Errors.BR_NAME_MISSING: HTTPStatus.BAD_REQUEST,
    Errors.BR_NOT_EXIST: HTTPStatus.BAD_REQUEST,
    Errors.BR_USER_NOT_FOUND: HTTPStatus.BAD_REQUEST,
    Errors.BR_USER_ALREADY_IN: HTTPStatus.BAD_REQUEST,
    Errors.BR_MISSING_PERMISSION: HTTPStatus.UNAUTHORIZED,
    Errors.BR_USER_NOT_IN: HTTPStatus.BAD_REQUEST,
    Errors.BR_USER_NOT_ACTIVE: HTTPStatus.UNAUTHORIZED,
    Errors.BR_BAD_NAME: HTTPStatus.BAD_REQUEST,
    Errors.BR_EXIST: HTTPStatus.BAD_REQUEST,
    Errors.BR_BAD_DESCRIPTION: HTTPStatus.BAD_REQUEST,
    Errors.BR_DESCRIPTION_MISSING: HTTPStatus.BAD_REQUEST,
