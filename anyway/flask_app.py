...
def markers():
    ...
    accidents_markers = markers.from_self().filter(Marker.provider_code != CONST.RSA_PROVIDER_CODE)
    rsa_markers = markers.from_self().filter(Marker.provider_code == CONST.RSA_PROVIDER_CODE)
