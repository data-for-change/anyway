...
from anyway.utilities import ItmToWGS84, time_delta, ImporterUI, truncate_tables, chunks, fetch_ids_for_chunking, \
...
def create_tables():
    ...
    try:
        with db.get_engine().begin() as conn:
            ...
            # run_query_and_insert_to_table_in_chunks(VIEWS.create_vehicles_hebrew_markers_view(),
            #                                         VehicleMarkerView, Vehicle.id, chunk_size, conn)

            #print(VIEWS.VEHICLES_HEBREW_VIEW)
            print(VIEWS.create_vehicles_hebrew_view())
