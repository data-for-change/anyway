...
def process_roads_table(addresses_df):
    ...
    roads.road1 = roads.road1.astype(str) if road1 and not np.isnan(road1) else None
    roads.road2 = roads.road2.astype(str) if road2 and not np.isnan(road2) else None
