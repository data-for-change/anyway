...
def insert_new_flash_news(id_flash, title, link, date_parsed, author, description, location, lat, lon, road1,
    ...
    db.session.execute('INSERT INTO news_flash (id,title, link, date, author, description, location, lat, lon, '
                       ...
                       :geo_extracted_road_no, :geo_extracted_intersection, :geo_extracted_city, :geo_extracted_address,\
                       ...
                       {'id': id_flash, 'title': title, 'link': link, 'date': date_parsed, 'author': author,
                        ...
                        'road2': int(road2) if road2 else road2, 'intersection': intersection, 'city': city, 'street': street, 'street2':street2,
                        'resolution':resolution, 'geo_extracted_street':geo_extracted_street, 'geo_extracted_road_no':geo_extracted_road_no,
                        'geo_extracted_intersection':geo_extracted_intersection,'geo_extracted_city':geo_extracted_city,
                        'geo_extracted_address':geo_extracted_address,'geo_extracted_district':geo_extracted_district,
