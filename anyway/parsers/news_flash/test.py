...
if __name__ == '__main__':
    ...
    text = u'''בית המשפט לתעבורה בפתח תקווה הגיש כתב אישום נגד נהג המשאית עלי עוודאללה, בן 25 מירושלים, בגין גרימת מוות ברשלנות של בריג'יט חבר ז"ל ופציעת שבעה בני אדם, בהם ילדים, בכביש 40 באוגוסט האחרון. '''
