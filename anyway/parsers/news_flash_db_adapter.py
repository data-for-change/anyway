...
class DBAdapter:
    ...
    def insert_new_newsflash(self, newsflash: NewsFlash, after_insertion_callback=None) -> None:
        ...
        if os.environ.get("FLASK_ENV") == "production" and newsflash.accident and after_insertion_callback:
            after_insertion_callback(newsflash)
