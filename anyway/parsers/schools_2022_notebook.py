{
    "cells": [
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["total_df = pd.read_csv(PATH_TO_FILE)"],
        },
        {"cell_type": "markdown", "metadata": {}, "source": ["## Add involved unique ID"]},
        {
            "cell_type": "code",
            "execution_count": 8,
            "metadata": {
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## Add accident unique ID"]},
        {
            "cell_type": "code",
            "execution_count": 9,
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Add 'vehicle_or_pedastrian' field"],
        },
        {
            "cell_type": "code",
            "execution_count": 10,
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["#### check vehicle_or_pedastrian"]},
        {
            "cell_type": "code",
            "execution_count": 11,
            "metadata": {
            ...
            "source": ["total_df['vehicle_or_pedastrian'].unique()"],
        },
        {
            "cell_type": "code",
            "execution_count": 12,
            ...
            "outputs": [
                {
                    "data": {"text/plain": ["(5831, 171)"]},
                    "execution_count": 12,
                    "metadata": {},
                    "output_type": "execute_result",
                }
            ],
            "source": ["total_df.shape"],
        },
        {"cell_type": "markdown", "metadata": {}, "source": ["### count schools"]},
        {
            "cell_type": "code",
            "execution_count": 13,
            "metadata": {
            ...
            "outputs": [
                {
                    "data": {"text/plain": ["1203"]},
                    "execution_count": 13,
                    "metadata": {},
                    "output_type": "execute_result",
                }
            ],
            "source": ["total_df.school_id.nunique()"],
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["# Generate accidents per city files"],
        },
        {
            "cell_type": "code",
            "execution_count": 19,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["# Get injuries summary for each city"],
        },
        {
            "cell_type": "code",
            "execution_count": 14,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["### Get injuries summary per school"],
        },
        {
            "cell_type": "code",
            "execution_count": 54,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["### Get injured with POINT(longitude, latitude)"],
        },
        {
            "cell_type": "code",
            "execution_count": 42,
            "metadata": {},
            "outputs": [],
            "source": ["injured_with_points = total_df.copy()"],
        },
        {
            "cell_type": "code",
            "execution_count": 43,
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["### Get schools with polygons"]},
        {
            "cell_type": "code",
            "execution_count": 50,
            "metadata": {},
            "outputs": [],
            "source": ["ids = total_df.school_id.unique()"],
        },
        {
            "cell_type": "code",
            "execution_count": 57,
