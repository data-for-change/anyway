class Views(object):
   ...
   FROM involved
     ...
     LEFT JOIN injury_severity_mais ON involved.injury_severity_mais = injury_severity_mais.id AND involved.accident_year = injury_severity_mais.year AND involved.provider_code = injury_severity_mais.provider_code;"""
   ...
   FROM vehicles
    ...
    involved_hebrew.vehicle_type,
    involved_hebrew.vehicle_type_hebrew,
    ...
    involved_hebrew.home_region,
    involved_hebrew.home_region_hebrew,
    involved_hebrew.home_district,
    involved_hebrew.home_district_hebrew,
    involved_hebrew.home_natural_area,
    involved_hebrew.home_natural_area_hebrew,
    involved_hebrew.home_municipal_status,
    involved_hebrew.home_municipal_status_hebrew,
    involved_hebrew.home_residence_type,
    involved_hebrew.home_residence_type_hebrew,
    ...
    involved_hebrew.injury_severity_mais,
    involved_hebrew.injury_severity_mais_hebrew,
    ...
    markers_hebrew.y
     ...
     INNER JOIN markers_hebrew ON involved_hebrew.provider_and_id = markers_hebrew.provider_and_id;"""
