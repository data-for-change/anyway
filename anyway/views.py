class Views(object):
    ...
    MARKERS_HEBREW_VIEW = """SELECT markers.id,
                                    ...
                                    markers.km_raw,
                                    markers.km_accurate,
                                    road_segments.segment_id road_segment_id,
                                    road_segments.segment road_segment_number,
   ...
   FROM vehicles
    ...
    markers_hebrew.segment_id road_segment_id,
    markers_hebrew.segment road_segment_number,
