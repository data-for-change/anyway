...
class InvolvedQuery:
    ...
    vehicle_type_to_str[13] = VehicleTypeHebrew("רכב עבודה והצלה", "רכב עבודה והצלה")
    ...
    vehicle_type_to_str[21] = VehicleTypeHebrew(None, None)
    vehicle_type_to_str[22] = VehicleTypeHebrew(None, None)
    vehicle_type_to_str[23] = VehicleTypeHebrew(None, None)
    vehicle_type_to_str[24] = VehicleTypeHebrew(None, None)
    vehicle_type_to_str[25] = VehicleTypeHebrew(None, None)
    vehicle_type_to_str[26] = VehicleTypeHebrew(None, None)
    vehicle_type_to_str[27] = VehicleTypeHebrew(None, None)
    vehicle_type_to_str[28] = VehicleTypeHebrew(None, None)
