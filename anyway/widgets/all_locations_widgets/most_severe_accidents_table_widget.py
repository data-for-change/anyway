...
def get_most_severe_accidents_table_title(
    ...
    if resolution == BE_CONST.ResolutionCategories.SUBURBAN_ROAD:
        ...
        return "Severe accidents in street", f" {location_info['street1_hebrew']} {_('in')} {location_info['yishuv_name']}"
    elif resolution == BE_CONST.ResolutionCategories.URBAN_JUNCTION:
        return "Severe accidents in street", f" {location_info['street1_hebrew']} {_('and')} {location_info['street2_hebrew']} {_('in')} {location_info['yishuv_name']}"
