...
def get_most_severe_accidents_table_title(
    ...
    if resolution == BE_CONST.ResolutionCategories.SUBURBAN_ROAD:
        return _("Most severe accidents in segment"), segment_dictionary[location_info["road_segment_name"]]
    elif resolution == BE_CONST.ResolutionCategories.STREET:
        return _("Severe accidents in street"), f" {location_info['street1_hebrew']} " + _("in ") + f"{location_info['yishuv_name']}"
