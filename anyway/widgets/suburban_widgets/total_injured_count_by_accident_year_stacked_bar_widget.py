...
@register
class TotalInjuredCountByAccidentYearWidget(SubUrbanWidget):
    name: str = "total_injured_count_by_accident_year_stacked_bar"

    def __init__(self, request_params: RequestParams):
        super().__init__(request_params, type(self).name)
        self.rank = 22
        self.information = _("Injured count in the specified years")
    ...
    def localize_items(request_params: RequestParams, items: Dict) -> Dict:
        items["data"]["text"] = {
            "title": _("Number of injured in accidents, per year")
