...
# sagi staging CLEARDB_DATABASE_URL=mysql://b8cf289d37bbb7:270d159a@eu-cdbr-west-01.cleardb.com/heroku_4e1f2a31664785d
# local CLEARDB_DATABASE_URL=sqlite:///local.db
CLEARDB_DATABASE_URL=sqlite:///local.db
