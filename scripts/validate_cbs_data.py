...
def main(cbs_directory_path, all_output_file_name, missing_files_output_file_name):
    ...
    for subdir, dirs, files in sorted(os.walk(cbs_directory_path)):
        ...
        if missing_files_list:
            ...
            missing_data_output_file.write('\t' + 'missing_files_list: ' + str(missing_files_list) + '\n\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--all_output_file_name', type=str, help='output file name for the whole output')
    parser.add_argument('--missing_files_output_file_name', type=str, help='output file name for the missing data')
