...
(function(a){a.jsPanel=function(c){var b;c=c||{};var d=c.config||{};b=a(c.template||jsPanel.template);b.option=a.extend(!0,{},a.jsPanel.defaults,d,c);"string"===typeof b.option.id?c=b.option.id:a.isFunction(b.option.id)?c=b.option.id():(jsPanel.ID+=1,c=jsPanel.ID);if(0<a("#"+c).length)return console.log("jsPanel Error: No jsPanel created - id attribute passed with option.id already exists in document"),!1;b.attr("id",c);b.data("custom",b.option.custom);b.verticalOffset=0;try{b.parentElmt=a(b.option.selector).first(),
