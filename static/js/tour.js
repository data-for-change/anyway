...
var tour = new Tour({
  ...
  },
  {
    ...
    animation: true,
    placement: 'bottom',
    content: '<p>כאן תוכלו להזין את כתובתכם או כתובת שאתם נוהגים לבקר בה.</p></br>'+'<p> לחיצה עךל ENTER תיקח אותכם אל הכתובת לדוגמא :</br>זבוטנסקי 74 פתח תקווה</p>',
    onNext: function ()
    {
        tourClickInput();
    }
  ...
  },
{
    ...
    content: '<p xmlns="http://www.w3.org/1999/html">כאן ניתן לבחור טוחח תאריכים להצגת תאונות.</br>לנוחותכם ישנם קיצורי דרך לשנה ספציפית וכן אפשרות לבחור כל טווח תאריכים באופן ידני.</br> לצורך הדוגמא נבחר להציג תאונות מיאנור 2006 עד ינואר 2014.</p>'
  },
]})
