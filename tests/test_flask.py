...
class TestSite(unittest.TestCase):
    ...
    def test_markers_empty(self):
        ...
        self.assertEqual(rv.status, '400 BAD REQUEST')  # TODO why?
    ...
    def test_markers(self):
        ...
        #self.assertGreaterEqual(len(resp['markers']), 5)  # it was 40 when I checked it and the 41 after reloading the data
