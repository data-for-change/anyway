...
def insert_infographic_mock_data(app):
    sql_insert = f"""
        ...
        tweet_id, district_hebrew, non_urban_intersection_hebrew, region_hebrew, road_segment_id, street1_hebrew, street2_hebrew, yishuv_name, newsflash_location_qualification, location_qualifying_user)
        values (
        true,
        'ynet',
        '2020-01-19 02:03:30',
